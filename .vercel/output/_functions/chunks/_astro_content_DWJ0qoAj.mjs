...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, r as renderTemplate, u as unescapeHTML, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, a as renderComponent } from './astro/server_D2lW42M0.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DhdZserU.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DnyAjpZT.mjs').then(n => n._);
