import { d as createAstro, c as createComponent, r as renderTemplate, u as unescapeHTML, m as maybeRenderHead, a as renderComponent, e as addAttribute, b as renderScript, j as renderHead, k as renderSlot } from './astro/server_CJ6p3tUL.mjs';
import 'kleur/colors';
import { $ as $$Image } from './_astro_assets_BeM7GfKh.mjs';
import 'clsx';
/* empty css                               */

const Logo$1 = new Proxy({"src":"/_astro/Logo.JuKQCNvz.svg","width":400,"height":120,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Adrían/Desktop/web-nexito/src/assets/Logo.svg";
							}
...
const $$JsonLD = createComponent(($$result, $$props, $$slots) => {
  ...
  const organizationSchema = {
    ...
    "logo": "https://nexito.technology/Logo.svg",
    "sameAs": [
...
}, "C:/Users/Adr\xEDan/Desktop/web-nexito/src/components/JsonLD.astro", undefined);
...
const $$Menu = createComponent(($$result, $$props, $$slots) => {
  ...
  const navigationSchema = {
    ...
    name: "Nexito Technology",
    url: "https://nexito.technology",
    // URL directa de tu sitio
    potentialAction: {
      "@type": "SearchAction",
      target: {
        "@type": "EntryPoint",
        urlTemplate: "https://nexito.technology/search?q={search_term_string}"
        // URL completa para búsqueda
      },
      "query-input": "required name=search_term_string"
    }
  };
  return renderTemplate`${maybeRenderHead()}<header class="sticky top-0 w-full bg-white/95 backdrop-blur-md shadow-lg z-50 border-b border-gray-100"> ${renderComponent($$result, "JsonLD", $$JsonLD, { "type": "WebSite", "data": navigationSchema })} <div class="max-w-7xl mx-auto px-4 sm:px-6"> <div class="flex justify-between items-center h-20">  <a href="/" class="flex-shrink-0 transform hover:scale-105 transition-transform duration-200" aria-label="Ir a la página principal"> ${renderComponent($$result, "Image", $$Image, { "src": menuData.logo.src, "alt": menuData.logo.alt, "loading": menuData.logo.loading, "width": 144, "height": 104, "format": "webp", "quality": 90, "class": "w-auto h-8 md:h-10" })} </a>  <nav class="hidden md:flex items-center gap-8" aria-label="Menú principal"> <div class="relative group"> <button class="flex items-center text-gray-600 hover:text-blue-600 font-medium transition-colors py-2" aria-expanded="false" aria-controls="desktop-services-menu" aria-haspopup="true">
Servicios
<svg class="ml-1.5 h-4 w-4 transform group-hover:rotate-180 transition-transform duration-200" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"> <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path> </svg> </button>  <div id="desktop-services-menu" class="absolute left-0 mt-1 w-64 bg-white rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top scale-95 group-hover:scale-100 border border-gray-100" role="menu" aria-orientation="vertical"> <div class="py-2"> ${menuData.services.map((service) => renderTemplate`<a${addAttribute(service.url, "href")} class="flex items-center px-4 py-2.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-colors" role="menuitem"> <span class="w-1.5 h-1.5 rounded-full bg-blue-600 opacity-0 transition-opacity duration-200 mr-2 group-hover:opacity-100"></span> ${service.title} </a>`)} </div> </div> </div> <a href="/blog" class="text-gray-600 hover:text-blue-600 font-medium transition-colors" aria-label="Ir al blog">
Blog
...
Contacto
</a> </div> </div> </header> ${renderScript($$result, "C:/Users/Adr\xEDan/Desktop/web-nexito/src/components/Menu.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/Adr\xEDan/Desktop/web-nexito/src/components/Menu.astro", undefined);

const Logo = new Proxy({"src":"/_astro/LogoFooter.DuEsngpw.svg","width":400,"height":120,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Adrían/Desktop/web-nexito/src/assets/LogoFooter.svg";
							}
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  const footerSchema = {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://nexito.technology/Logo.svg"
    },
    "contactPoint": {
      "@type": "ContactPoint",
...
}, "C:/Users/Adr\xEDan/Desktop/web-nexito/src/components/Footer.astro", undefined);
...
Aceptar todas
</button> </div> </div> </div> </div> ${renderScript($$result, "C:/Users/Adr\xEDan/Desktop/web-nexito/src/components/CookieConsent.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/Adr\xEDan/Desktop/web-nexito/src/components/CookieConsent.astro", undefined);
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "C:/Users/Adr\xEDan/Desktop/web-nexito/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/Adr\xEDan/Desktop/web-nexito/node_modules/astro/components/ClientRouter.astro", undefined);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es" class="scroll-smooth"> <head><!-- Metadatos básicos --><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="description"${addAttribute(description, "content")}><title>${title}</title><!-- SEO mejorado --><link rel="canonical"${addAttribute(canonicalURL, "href")}><meta name="robots" content="index, follow, max-image-preview:large"><meta name="author" content="Nexito Technology"><meta name="generator"${addAttribute(Astro2.generator, "content")}><!-- Open Graph mejorado --><meta property="og:locale" content="es_ES"><meta property="og:site_name" content="Nexito Technology"><meta property="og:type"${addAttribute(type === "article" ? "article" : "website", "content")}><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:image"${addAttribute(new URL(image, siteURL), "content")}><meta property="og:image:alt"${addAttribute(title, "content")}><meta property="og:url"${addAttribute(canonicalURL, "content")}><!-- Twitter Card mejorada --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"${addAttribute(title, "content")}><meta name="twitter:description"${addAttribute(description, "content")}><meta name="twitter:image"${addAttribute(new URL(image, siteURL), "content")}><meta name="twitter:image:alt"${addAttribute(title, "content")}><!-- Favicon y manifest mejorado --><!--<link rel="icon" href="/favicon.ico" sizes="32x32" /> --><!-- Favicon y manifest mejorado --><link rel="icon" href="/Favicon.svg" type="image/svg+xml"><link rel="apple-touch-icon" href="/Logo.svg"><link rel="manifest" href="/site.webmanifest"><!-- Preconexiones para mejorar rendimiento --><link rel="preconnect" href="https://fonts.googleapis.com" crossorigin="anonymous"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="anonymous"><!-- Precargar fuentes críticas --><link rel="preload" href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">${maybeRenderHead()}<noscript><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet"></noscript><!-- JSON-LD Schemas -->${renderComponent($$result, "JsonLD", $$JsonLD, { "type": "Organization", "data": {} })}${renderComponent($$result, "JsonLD", $$JsonLD, { "type": "WebSite", "data": {} })}${renderComponent($$result, "JsonLD", $$JsonLD, { "type": getSchemaType(), "data": {
    ...baseSchema,
    ...schemaData
  } })}<!-- Astro View Transitions -->${renderComponent($$result, "ClientRouter", $$ClientRouter, {})}${renderHead()}</head> <body class="font-[Inter] bg-gradient-to-b from-white to-gray-50 min-h-screen flex flex-col"> <!-- Skip to main content para accesibilidad --> <a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-blue-600 focus:text-white focus:rounded">
Saltar al contenido principal
</a> ${renderComponent($$result, "Menu", $$Menu, {})} <!-- Gradient background --> <div class="bg-gradient-to-b from-[#0B1120] to-transparent h-32 w-full absolute top-0 -z-10 opacity-10"></div> <!-- Main content --> <main id="main-content" class="flex-grow"> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, {})} ${renderComponent($$result, "CookieConsent", $$CookieConsent, {})} <!-- Script para mejorar el rendimiento de las fuentes --> ${renderScript($$result, "C:/Users/Adr\xEDan/Desktop/web-nexito/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
}, "C:/Users/Adr\xEDan/Desktop/web-nexito/src/layouts/Layout.astro", undefined);

export { $$JsonLD as $, $$Layout as a };
