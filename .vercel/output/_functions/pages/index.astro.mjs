import { c as createComponent, m as maybeRenderHead, r as renderComponent, b as renderTemplate, g as addAttribute, a as renderScript } from '../chunks/astro/server_CpFO4I6n.mjs';
import 'kleur/colors';
...
Intentar de nuevo
</button> </div> </div> </div> ${renderScript($$result, "C:/ProyectosProgramacion/web-nexito-vercel/src/components/PopupNewsletter.astro?astro&type=script&index=0&lang.ts")}`;
