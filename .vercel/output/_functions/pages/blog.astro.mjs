/* empty css                                       */
import { d as createAstro, c as createComponent, r as renderTemplate, a as renderComponent, b as renderScript, m as maybeRenderHead, e as addAttribute } from '../chunks/astro/server_CJ6p3tUL.mjs';
import 'kleur/colors';
import { g as getCollection } from '../chunks/_astro_content_B3cXCnDJ.mjs';
...
const $$Blog = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const title = "Blog | Nexito Technology";
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title, "description": description, "type": "website", "data-astro-cid-ijnerlr2": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "JsonLD", $$JsonLD, { "type": "WebPage", "data": blogListSchema, "data-astro-cid-ijnerlr2": true })} ${maybeRenderHead()}<main class="max-w-7xl mx-auto px-4 py-12" data-astro-cid-ijnerlr2> <header class="text-center mb-16" data-astro-cid-ijnerlr2> <h1 class="text-5xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent" data-astro-cid-ijnerlr2>
